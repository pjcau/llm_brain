...
Generated by `brain setup claude-code` and `brain setup aider --docker
llm-brain-aider-test:latest`; copied here for reference. Only variable
*names* appear.
...
| `brain setup claude-code [--profile dev]` | — |
